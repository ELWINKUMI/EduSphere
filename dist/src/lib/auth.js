...
export function sendPasswordResetEmail(email, resetLink) {
    return __awaiter(this, void 0, void 0, function () {
        var smtpHost, smtpPort, smtpUser, smtpPass, fromEmail, transporter, mailOptions;
...
export function getServerSession(req) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, token, decoded, user, _a;
