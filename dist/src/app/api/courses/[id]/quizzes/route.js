...
export function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var courseId, authorization, token, decoded, course, quizzes, submissions_1, formattedQuizzes, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    submissions_1 = _c.sent();
                    formattedQuizzes = quizzes.map(function (quiz) {
                        var submission = submissions_1.find(function (s) { return s.quiz.toString() === quiz._id.toString(); });
                        var now = new Date();
                        ...
                        return {
                            ...
                            maxScore: submission === null || submission === void 0 ? void 0 : submission.maxScore
                        };
                    });
