...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, token, decoded, user, url, limit, submissions, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!user || user.role !== 'student') {
                        return [2 /*return*/, NextResponse.json({ error: 'Only students can view their submissions' }, { status: 403 })];
                    }
                    url = new URL(request.url);
                    limit = parseInt(url.searchParams.get('limit') || '5', 10);
                    return [4 /*yield*/, Submission.find({ student: user._id })
                            .populate({
                            path: 'assignment',
                ...
                case 3:
                    submissions = _a.sent();
                    return [2 /*return*/, NextResponse.json({ submissions: submissions })];
                case 4:
                    error_1 = _a.sent();
                    console.error('Get student submissions error:', error_1);
