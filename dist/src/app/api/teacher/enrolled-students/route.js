...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, token, decoded, teacher, courses, studentMap_1, enrolledStudents, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!teacher || teacher.role !== 'teacher') {
                        return [2 /*return*/, NextResponse.json({ error: 'Only teachers can view enrolled students' }, { status: 403 })];
                    }
                ...
                case 3:
                    ...
                    courses.forEach(function (course) {
                        course.students.forEach(function (student) {
                            if (!studentMap_1.has(student._id.toString())) {
                                studentMap_1.set(student._id.toString(), {
                                    _id: student._id,
                                    name: student.name,
                            ...
                            var studentData = studentMap_1.get(student._id.toString());
                    ...
                    enrolledStudents = Array.from(studentMap_1.values());
                    return [2 /*return*/, NextResponse.json({
                            students: enrolledStudents
                        })];
                case 4:
                    error_1 = _a.sent();
                    console.error('Get enrolled students error:', error_1);
