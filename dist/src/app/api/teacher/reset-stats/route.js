...
export function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, token, userId, decoded, teacher, courses, _i, courses_1, course, e_1;
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (!teacher || teacher.role !== 'teacher') {
                        return [2 /*return*/, NextResponse.json({ error: 'Not found or not a teacher.' }, { status: 404 })];
                    }
                ...
                // teacher.grades = [];
                // await teacher.save();
                return [2 /*return*/, NextResponse.json({ message: 'Your records and stats have been reset for the new term.' })];
                case 12:
                    e_1 = _a.sent();
                    return [2 /*return*/, NextResponse.json({ error: 'Failed to reset records.' }, { status: 500 })];
