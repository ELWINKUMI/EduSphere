...
export function POST(req, context) {
    return __awaiter(this, void 0, void 0, function () {
        var session, courseId, _a, assignmentWeight, quizWeight, gradeRanges;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    _a = _b.sent(), assignmentWeight = _a.assignmentWeight, quizWeight = _a.quizWeight, gradeRanges = _a.gradeRanges;
                ...
                case 5:
                    _b.sent();
                    return [2 /*return*/, NextResponse.json({ message: 'Grading scheme updated.' })];
            }
        });
    });
}
