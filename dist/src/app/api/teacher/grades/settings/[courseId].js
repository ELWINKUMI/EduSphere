...
export function POST(req_1, _a) {
    return __awaiter(this, arguments, void 0, function (req, _b) {
        var session, courseId, _c, assignmentWeight, quizWeight, gradeRanges, course;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    _c = _d.sent(), assignmentWeight = _c.assignmentWeight, quizWeight = _c.quizWeight, gradeRanges = _c.gradeRanges;
                ...
                case 5:
                    _d.sent();
                    return [2 /*return*/, NextResponse.json({ course: course })];
            }
        });
    });
}
