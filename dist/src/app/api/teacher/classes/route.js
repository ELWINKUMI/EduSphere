...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var token, auth, userId, decoded, teacher, courses, e_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Course.find({ teacher: teacher._id }).select('title subject gradeLevel isActive')];
                case 4:
                    courses = _b.sent();
                    return [2 /*return*/, NextResponse.json({ classes: courses })];
                case 5:
                    e_1 = _b.sent();
                    return [2 /*return*/, NextResponse.json({ message: 'Failed to fetch classes.' }, { status: 500 })];
