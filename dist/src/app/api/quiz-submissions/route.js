...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authorization, token, decoded, submissions, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    submissions = _a.sent();
                    return [2 /*return*/, NextResponse.json({ submissions: submissions }, { status: 200 })];
                case 3:
                    error_1 = _a.sent();
                    console.error('Error fetching quiz submissions:', error_1);
