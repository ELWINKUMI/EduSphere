...
export function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var courseId, authorization, token, decoded, course, quizzes, quizzesWithStats, error_1;
        var _this = this;
            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    if (decoded.role !== 'teacher') {
                        return [2 /*return*/, NextResponse.json({ message: 'Only teachers can view this data' }, { status: 403 })];
                    }
                ...
                case 4:
                    quizzes = _c.sent();
                    return [4 /*yield*/, Promise.all(quizzes.map(function (quiz) { return __awaiter(_this, void 0, void 0, function () {
                            var submissionCount;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, QuizSubmission.countDocuments({ quiz: quiz._id })];
                                    case 1:
                ...
                case 5:
                    quizzesWithStats = _c.sent();
                    return [2 /*return*/, NextResponse.json({
                            quizzes: quizzesWithStats
                        }, { status: 200 })];
                case 6:
                    error_1 = _c.sent();
                    console.error('Error fetching course quizzes:', error_1);
