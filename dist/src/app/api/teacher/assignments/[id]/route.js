...
export function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var id, token, decoded, teacher, assignment, formData, title, description, dueDate, maxPoints, submissionType, existingAttachmentsStr, existingAttachments_1, newFiles, attachmentFiles, _loop_1, _i, attachmentFiles_1, file, deletedFiles, _c, deletedFiles_1, filename, filepath, error_1, updatedAssignment, error_2;
        var _d;
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 13:
                    error_1 = _e.sent();
                    console.error('Error deleting file:', filename, error_1);
                    return [3 /*break*/, 14];
                case 14:
                    _c++;
                    return [3 /*break*/, 10];
                ...
                case 17:
                    error_2 = _e.sent();
                    console.error('Error updating assignment:', error_2);
...
export function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var id, token, decoded, teacher, assignment, _i, _c, filename, filepath, error_3, error_4;
        var _d;
        var params = _b.params;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 8:
                    error_3 = _e.sent();
                    console.error('Error deleting file:', filename, error_3);
                    return [3 /*break*/, 9];
                case 9:
                    _i++;
                    return [3 /*break*/, 5];
                ...
                case 12:
                    error_4 = _e.sent();
                    console.error('Error deleting assignment:', error_4);
                    return [2 /*return*/, NextResponse.json({ error: 'Internal server error' }, { status: 500 })];
