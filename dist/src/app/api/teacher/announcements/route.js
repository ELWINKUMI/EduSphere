...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authorization, token, decoded, announcements, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Announcement.find({ teacher: decoded.userId })
                            .sort({ createdAt: -1 })
                            .lean()];
                case 2:
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error('Error fetching teacher announcements:', err_1);
