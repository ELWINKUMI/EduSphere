...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, token, decoded, teacher, subjects, formattedSubjects, error_1;
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!teacher || teacher.role !== 'teacher') {
                        return [2 /*return*/, NextResponse.json({ error: 'Only teachers can view subjects' }, { status: 403 })];
                    }
                ...
                case 3:
                    subjects = _a.sent();
                    formattedSubjects = subjects.map(function (subject) { return ({
                        _id: subject._id,
                        title: subject.title,
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('Get teacher subjects error:', error_1);
