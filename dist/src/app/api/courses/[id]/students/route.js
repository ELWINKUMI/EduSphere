...
export function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var courseId, authorization, token, decoded, course, students, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Course.findById(courseId).populate('students', 'name email createdAt')];
                case 3:
                    course = _c.sent();
                    if (!course) {
                    ...
                    students = course.students.map(function (student) { return ({
                        _id: student._id,
                        name: student.name,
                        email: student.email,
                ...
                case 4:
                    error_1 = _c.sent();
                    console.error('Error fetching course students:', error_1);
