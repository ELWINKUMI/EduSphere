...
export function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var _i, teachers_1, teacherData, teacher, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    _a.label = 3;
                case 3:
                    if (!(_i < teachers_1.length)) return [3 /*break*/, 6];
                    teacherData = teachers_1[_i];
                    teacher = new User(teacherData);
                    return [4 /*yield*/, teacher.save()];
                case 4:
                    _a.sent();
                    console.log("Added teacher: ".concat(teacherData.name));
                    _a.label = 5;
                case 5:
                    _i++;
                    return [3 /*break*/, 3];
                ...
                case 7:
                    error_1 = _a.sent();
                    console.error('Reset database error:', error_1);
