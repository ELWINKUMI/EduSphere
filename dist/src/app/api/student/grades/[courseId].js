        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, StudentReport.findOne({ course: courseId, student: session.user._id })];
                case 3:
                    report = _c.sent();
                    if (!report) {
                        return [2 /*return*/, NextResponse.json({ message: 'Report not available' }, { status: 404 })];
                    }
