            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (res.ok) {
                        ...
                        setTimeout(function () { return router.push("/auth/login"); }, 2000);
                    }
                    else {
      ...
      <div className="w-full max-w-md bg-white/90 dark:bg-gray-900/95 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 p-8 flex flex-col gap-6">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input type="password" id="password" name="password" className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:outline-none transition-colors" value={password} onChange={function (e) { return setPassword(e.target.value); }} required autoComplete="new-password" disabled={loading}/>
          </div>
          <div>
            ...
            <input type="password" id="confirmPassword" name="confirmPassword" className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:outline-none transition-colors" value={confirmPassword} onChange={function (e) { return setConfirmPassword(e.target.value); }} required autoComplete="new-password" disabled={loading}/>
          </div>
