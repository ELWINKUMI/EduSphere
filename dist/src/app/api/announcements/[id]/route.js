...
export function PATCH(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var id, authorization, token, decoded, announcement_1, data_1, updatable, err_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 5:
                    err_1 = _c.sent();
                    console.error('Error updating announcement:', err_1);
...
export function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var id, authorization, token, decoded, announcement, err_2;
        var params = _b.params;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 5:
                    err_2 = _c.sent();
                    console.error('Error deleting announcement:', err_2);
                    return [2 /*return*/, NextResponse.json({ message: 'Server error' }, { status: 500 })];
                case 6: return [2 /*return*/];
            }
        });
