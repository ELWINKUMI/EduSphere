...
export function GET(request) {
    return __awaiter(this, void 0, void 0, function () {
        var token, auth, userId, decoded, user, enrolledCourses, e_1;
        var _a;
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if (!user || user.role !== 'student') {
                        return [2 /*return*/, NextResponse.json({ message: 'Not found or not a student.' }, { status: 404 })];
                    }
...
export function PUT(request) {
    return __awaiter(this, void 0, void 0, function () {
        var auth, token, userId, decoded, _a, name, email, password, update, user, e_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, connectDB()];
                case 1:
