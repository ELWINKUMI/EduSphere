        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, User_1.default.findOne({ role: 'student', name: studentName })];
                case 2:
                    student_1 = _a.sent();
                    if (!student_1) {
                    ...
                    return [4 /*yield*/, Course_1.default.findOne({ subject: courseSubject, gradeLevel: courseGrade })];
                case 3:
                    course = _a.sent();
                    if (!course) {
