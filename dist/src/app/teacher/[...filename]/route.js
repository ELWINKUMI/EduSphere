...
export function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var filename, fullFilename, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    fullFilename = filename.join('/');
                    console.log('Incorrect file access attempt:', "/teacher/".concat(fullFilename));
                    ...
                    if (fullFilename.match(/^\d+-[a-f0-9]+-/)) {
                        ...
                        return [2 /*return*/, NextResponse.redirect(new URL("/api/submissions/download/".concat(fullFilename), request.url))];
                    }
                    // Check if this looks like an assignment file
                    console.log('Redirecting assignment file to correct API:', fullFilename);
                    return [2 /*return*/, NextResponse.redirect(new URL("/api/assignments/download/".concat(fullFilename), request.url))];
                case 2:
                    error_1 = _c.sent();
                    console.error('Error in teacher file redirect:', error_1);
